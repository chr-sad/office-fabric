 ...
 * {@docCategory FocusZone}
 */
export interface IFocusZoneProps extends HTMLAttributes {
  /**
   ...
   */
  isInnerZoneKeystroke?: (ev: KeyboardEvent) => boolean;
   ...
   */
  shouldEnterInnerZone?: (ev: KeyboardEvent) => boolean;
   ...
   */
  onActiveElementChanged?: (element?: HTMLElement, ev?: FocusEvent) => void;
